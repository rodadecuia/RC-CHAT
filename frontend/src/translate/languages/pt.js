const messages = {
  pt: {
    translations: {
      ...
      about: {
        aboutthe: "Sobre o RC Chat",
        copyright: "© 2024 - Funcionando com RC Chat",
        buttonclose: "Fechar",
        title: "Sobre o RC Chat",
        abouttitle: "Origem e melhorias",
        aboutdetail: "O RC Chat é derivado indireto do projeto Whaticket com melhorias compartilhadas pelos desenvolvedores do sistema EquipeChat através do canal VemFazer no youtube, posteriormente melhoradas por Claudemir Todo Bom",
        ...
        licensedetail: "O RC Chat está licenciado sob a GNU Affero General Public License versão 3, isso significa que qualquer usuário que tiver acesso a esta aplicação tem o direito de obter acesso ao código fonte. Mais informações nos links abaixo:",
        licensefulltext: "Texto completo da licença",
        licensesourcecode: "Código fonte do RC Chat"
      },
      schedules: {
        title: "Agendamentos",
        confirmationModal: {
      ...
      settings: {
        ...
        whmcsTicketIntegration: {
          title: "Conectar ticket com WHMCS",
        },
      },
      messagesList: {
        header: {
      ...
      wavoipModal: {
        ...
        coupon: "Ao contratar o serviço use o cupom RCCHAT para ganhar um desconto!",
      },
      rcchat: {
        registration: {
          header: "Cadastre-se na base de usuários do RC Chat",
          description: "Preencha os campos abaixo para se cadastrar na base de usuários do RC Chat e receber novidades sobre o projeto.",
          name: "Nome",
          country: "País",
        ...
        support: {
          title: "Apoie o projeto RC Chat Open Source",
