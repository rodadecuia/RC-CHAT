...
const IntegrationSession_1 = __importDefault(require("./IntegrationSession"));
let Ticket = Ticket_1 = class Ticket extends sequelize_typescript_1.Model {
    static setUUID(ticket) {
        ticket.uuid = (0, uuid_1.v4)();
    }
    get lastContactMessageAt() {
        return this.getDataValue("lastContactMessageAt");
    }
    // After find hook to populate the virtual field using a query.
    static async attachLastContactMessageAt(found) {
    ...
    `;
        const results = await Ticket_1.sequelize.query(query, {
            replacements: { contactId, whatsappId },
            type: sequelize_1.QueryTypes.SELECT
        });
        // Assign computed value to each ticket.
        found.setDataValue("lastContactMessageAt", results[0]?.lastContactMessageAt || null);
    }
};
__decorate([
...
], Ticket.prototype, "ticketTrakings", void 0);
__decorate([
    (0, sequelize_typescript_1.HasOne)(() => IntegrationSession_1.default, {
        onDelete: "CASCADE",
        onUpdate: "CASCADE",
        hooks: true
    }),
    __metadata("design:type", IntegrationSession_1.default)
], Ticket.prototype, "integrationSession", void 0);
__decorate([
...
], Ticket, "attachLastContactMessageAt", null);
