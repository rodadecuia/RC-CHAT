...
const UserSocketSession_1 = __importDefault(require("./UserSocketSession")); // Importação da nova model
const WebpushSubscription_1 = __importDefault(require("./WebpushSubscription"));
...
__decorate([
    sequelize_typescript_1.Column,
    __metadata("design:type", Boolean)
], User.prototype, "hideAdminUI", void 0);
__decorate([
...
__decorate([
    (0, sequelize_typescript_1.HasMany)(() => UserSocketSession_1.default, {
        onUpdate: "CASCADE",
        onDelete: "CASCADE"
    }),
    __metadata("design:type", Array)
], User.prototype, "socketSessions", void 0);
__decorate([
    (0, sequelize_typescript_1.HasMany)(() => WebpushSubscription_1.default, {
        onUpdate: "CASCADE",
        onDelete: "CASCADE"
    }),
    __metadata("design:type", Array)
], User.prototype, "webpushSubscriptions", void 0);
__decorate([
