...
async function createCounters(queryInterface, transaction, serie, timeField) {
...
exports.default = {
    up: async (queryInterface) => {
        ...
        `, { transaction });
            ...
            await createCounters(queryInterface, transaction, "ticket-create", "createdAt");
            await createCounters(queryInterface, transaction, "ticket-accept", "startedAt");
            await createCounters(queryInterface, transaction, "ticket-transfer", "queuedAt");
            await createCounters(queryInterface, transaction, "ticket-close", "finishedAt");
