...
const OldMessage_1 = __importDefault(require("../models/OldMessage"));
...
const UserSocketSession_1 = __importDefault(require("../models/UserSocketSession"));
const OutOfTicketMessages_1 = __importDefault(require("../models/OutOfTicketMessages"));
const Translation_1 = __importDefault(require("../models/Translation"));
const Wavoip_1 = __importDefault(require("../models/Wavoip"));
const Integration_1 = __importDefault(require("../models/Integration"));
const IntegrationSession_1 = __importDefault(require("../models/IntegrationSession"));
const NotificamehubIdMapping_1 = __importDefault(require("../models/NotificamehubIdMapping"));
const QuickPix_1 = __importDefault(require("../models/QuickPix"));
const WebpushSubscription_1 = __importDefault(require("../models/WebpushSubscription"));
...
const models = [
    Company_1.default,
    User_1.default,
    UserSocketSession_1.default,
    Contact_1.default,
    ContactTag_1.default,
    Ticket_1.default,
    Message_1.default,
    OldMessage_1.default,
    Whatsapp_1.default,
    WhatsappLidMap_1.default,
    ...
    Invoices_1.default,
    OutOfTicketMessages_1.default,
    QuickPix_1.default,
    Subscriptions_1.default,
    Translation_1.default,
    Wavoip_1.default,
    Integration_1.default,
    IntegrationSession_1.default,
    NotificamehubIdMapping_1.default,
    WebpushSubscription_1.default
];
